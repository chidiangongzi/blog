...
x0 = np.empty([nn], dtype=float)
y0 = np.empty([nn], dtype=float)
z0 = np.empty([nn], dtype=float)
d0 = np.empty([nn], dtype=float)
...
data1 = np.loadtxt("./ccn-50/data/Trajectory-0.5.txt")
embryo = np.loadtxt("./ccn-50/data/Embryo-D-0.5.txt")
...
data1 = np.loadtxt("./ccn-200/data/Trajectory-0.5.txt")
embryo = np.loadtxt("./ccn-200/data/Embryo-D-0.5.txt")
first_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 0:nt] / 2)
second_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, nt:2*nt] / 2)
third_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 2*nt:3*nt] / 2)
d[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 3*nt:4*nt])
...
data1 = np.loadtxt("./ccn-2000/data/Trajectory-0.5.txt")
embryo = np.loadtxt("./ccn-2000/data/Embryo-D-0.5.txt")
first_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 0:nt] / 2)
second_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, nt:2*nt] / 2)
third_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 2*nt:3*nt] / 2)
d[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 3*nt:4*nt])
...
data1 = np.loadtxt("./ccn-10000/data/Trajectory-0.5.txt")
embryo = np.loadtxt("./ccn-10000/data/Embryo-D-0.5.txt")
first_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 0:nt] / 2)
second_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, nt:2*nt] / 2)
third_2000[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 2*nt:3*nt] / 2)
d[:, 0:nn + 1] = np.transpose(data1[0:nn + 1, 3*nt:4*nt])
...
ax.spines['right'].set_linewidth(0)
ax.spines['bottom'].set_linewidth(bwith)
plt.ylabel('Diameter of Hail Embryo  (cm)',
           fontsize=18)
labels = ["0.5~1cm", "1~1.5cm", "1.5~2cm", "2~2.5cm", ">2.5cm"]
...
#           fontsize=12,
#           borderpad=0.3,
##           bbox_to_anchor=(1.0, 0.5, 0.5, 0.5)) #绘制表示框，右下角绘制
#           bbox_to_anchor=(0.5, 0.5, -0.5, 12.0)) #绘制表示框，右下角绘制
plt.savefig(fname="Em-D-box.png")
#plt.show()
